...
These data sets need to be downloaded from the course GitHub page. They are located in the `03-data` as csv files (`yield19.csv` and `yield20.csv`). Copy them from the downloaded GitHub folder and paste into your `data` folder of project `04 yield monitor`.  
...
- Export the cleaned version to file (save it to the `data` folder of your `04 yield monitor` project).    
...
After answering all questions, include your initials on the file name (e.g., A5-questions-LMB.qmd), render it, and send me the .html to **lmbastos@uga.edu** by **Tuesday, Feb 14th 11:59 pm**.  
