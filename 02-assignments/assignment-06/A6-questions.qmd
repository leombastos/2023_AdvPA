...
- Deadline is Thursday Feb 16th 11:59 pm (we will use all 3 interpolated cleaned yield data on our next steps). 
...
After answering all questions, include your initials on the file name (e.g., A6-questions-LMB.qmd), render it, and send the .html to **lmbastos@uga.edu** by **Thursday, Feb 15th 11:59 pm**.  
