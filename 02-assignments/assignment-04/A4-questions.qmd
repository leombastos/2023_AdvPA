...
After answering all questions, render this quarto file to html, include your initials on the file name (e.g., A4-questions-LMB.html) and send to **lmbastos@uga.edu** by **Monday, Feb 06 11:59 pm**.  
